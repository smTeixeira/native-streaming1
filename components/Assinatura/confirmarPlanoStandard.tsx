...
import { StandardConfirm } from './standard';
...
const ConfirmarPlanoStandard = ({ onCancel, onConfirm }: ConfirmarPlanoProps) => {
        ...
        <View>
          ...
          <View style={styles.confirmationContainer}>
            ...
            <Text style={styles.confirmationDescription}>
              Tem certeza que quer trocar seu plano atual pelo standard?
            </Text>
          </View>

          <StandardConfirm onCancel={onCancel} onNext={handleConfirm} />
        </View>
      ) : (
        <View>
          <BotaoVoltar onClick={onCancel} />
...
export default ConfirmarPlanoStandard;