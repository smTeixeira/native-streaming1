      ...
      {!isSuccess ? (
        <>
          <View style={styles.content}>
            ...
            <Text style={styles.description}>
              ...
              <Text style={styles.boldText}>teste@gmail.com</Text>. {'\n'}
              Informe-o abaixo para confirmar seu email.
            </Text>
        ...
        <>
          <View style={styles.successContainer}>
            <Text style={styles.successTitle}>Email confirmado com sucesso!</Text>
            <Text style={styles.successDescription}>
              Seu novo email foi cadastrado com sucesso.
            </Text>
          </View>
